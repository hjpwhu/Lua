...
local function train(words)
    ...
    local input = torch.Tensor(g_params.batchsize, g_params.edim)
    local target = torch.Tensor(g_params.batchsize)
    local context = torch.Tensor(g_params.batchsize, g_params.memsize)
    local time = torch.Tensor(g_params.batchsize, g_params.memsize)
...
g_words_train = g_read_words('ptb/train.txt', g_vocab, g_ivocab)
g_words_valid = g_read_words('ptb/valid.txt', g_vocab, g_ivocab)
g_words_test = g_read_words('ptb/test.txt', g_vocab, g_ivocab)
